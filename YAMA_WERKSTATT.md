...
| Datum | Änderung |
|---|---|
| Juli 2026 | Navigation neu geordnet: Meta-Seiten (Literatur, Werkstatt, Fazit) ans Ende der Sidebar; oben neue Seite „Wegweiser – so nutzen Sie diese Plattform“ (Aufbau, Lesekonventionen, drei Nutzungswege, Materialien). Parallel in der DE–TR-Fassung. |
